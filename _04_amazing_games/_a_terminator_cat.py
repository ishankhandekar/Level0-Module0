...
if __name__ == '__main__':
    ...
    set_background("C:/Users/Ishan Khandekar/Documents/GitHub/Level0-Module0/_04_amazing_games/cat.png")
    # 3. Make a new turtle
    t = turtle.Turtle()
    ...
    #    and initialize them:
    left_eye  = Eye(eye=t, x=-43, y=-4, radius=30)
    right_eye = Eye(eye=t, x=39, y=-1, radius=30)
